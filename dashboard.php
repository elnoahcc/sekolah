<?php
// PENTING: Tambahkan session_start() di awal
session_start();
...
// Validasi login - perbaikan untuk debugging
...
<svg xmlns="http://www.w3.org/2000/svg" class="small-box-icon w-10 h-10" viewBox="0 0 24 24" fill="currentColor">
  <path d="M11.7 1.61a1.875 1.875 0 01.6 0l10.5 3a.75.75 0 010 1.42l-10.5 3a1.875 1.875 0 01-.6 0l-10.5-3a.75.75 0 010-1.42l10.5-3zM21 9.348v4.652a2.25 2.25 0 01-1.5 2.13v3.12a.75.75 0 01-1.5 0v-2.846a11.94 11.94 0 01-12 0v2.846a.75.75 0 01-1.5 0v-3.12A2.25 2.25 0 013 14V9.348l8.4 2.4a3.375 3.375 0 001.2 0l8.4-2.4z"/>
                  ...
                  >
                    Data Siswa <i class="bi bi-link-45deg"></i>
                  </a>
                </div>
  ...
  <path d="M12 2L3 7v13h18V7l-9-5zM8 18v-5h8v5H8zm0-7v-3l4-2 4 2v3H8z"/>
                  ...
                  <a
                    ...
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    Data Jurusan <i class="bi bi-link-45deg"></i>
                  </a>
                </div>
...
>
  <path d="M21 12.79A9 9 0 1111.21 3a7 7 0 009.79 9.79z" />
                  ...
                  >
                    Data Agama <i class="bi bi-link-45deg"></i>
                  </a>
                </div>
